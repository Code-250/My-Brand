...
const BlogList = ()=>{
    ...
    return(
        ...
        <div style={{width:"100%"}}>
            <h1  style={{color:"#7e7b7b",textAlign:"center"}}>blogs</h1>
                        ...
                        return(
                            <li key={id} className="blog-item">
                                <div className="blog-content">
                                    <img className="blog-images" src={blogObject[id].fileUrl} alt="blog-pic"/>
                                    <h2>{blogObject[id].title}</h2>
                                    <p dengerouslySetInnerHTML={{__html: blogObject[id].body}}></p>
                                </div>
